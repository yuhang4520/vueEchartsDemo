...
import rotateColorfulCom from "./demoCom/rotateColorful"; // 旋转多彩图
import waterPoloCom from "./demoCom/waterPolo"; // 水球图
import pyramidTrendCom from "./demoCom/pyramidTrend"; // 金字塔趋势
